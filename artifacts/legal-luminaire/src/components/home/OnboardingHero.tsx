...
const WORKFLOW_STEPS = [
  ...
  { n: "2", label: "Research", hi: "शोध",      desc: "Fact-Fit Gate scores every precedent 0-100",    route: "/case-research",    color: "bg-violet-500" },
  { n: "3", label: "Verify",   hi: "सत्यापन", desc: "5-tier check — PENDING citations hard-blocked", route: "/verification",     color: "bg-green-500" },
  { n: "4", label: "Draft",    hi: "प्रारूप", desc: "Bilingual draft with verbatim citations",       route: "/safe-draft",       color: "bg-amber-500" },
  { n: "5", label: "Review",   hi: "समीक्षा", desc: "Pre-filing checklist + Verification Report",    route: "/filing-checklist", color: "bg-primary" },
];
      ...
      <div className="rounded-xl border bg-muted/20 p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
          {[
            ...
            { n: "2", label: "Research Precedents",  hi: "मिसालें खोजें",   route: "/case-research",   cls: "bg-blue-500 text-white hover:bg-blue-600" },
            { n: "3", label: "Draft a Document",     hi: "दस्तावेज़ लिखें", route: "/ai-draft-engine", cls: "bg-violet-500 text-white hover:bg-violet-600" },
