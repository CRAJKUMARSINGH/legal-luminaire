...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { path: "/chronology",       label: "कालक्रम स्टूडियो", labelEn: "Chronology Studio", icon: Clock, caseScoped: true, badge: "NEW" },
      { path: "/deadlines",        label: "समय-सीमा बोर्ड", labelEn: "Deadline Board", icon: AlertCircle, caseScoped: true, badge: "NEW" },
    ],
    secondary: [
  ...
  },
  {
    ...
    secondary: [
      ...
      { path: "/lps-precedents", label: "LPS Precedents", labelEn: "LPS Precedents", icon: BookOpen, caseScoped: false, badge: "LPS" },
      ...
      { path: "/ldr-packet", label: "LDR Packet", labelEn: "LDR Packet", icon: FileText, caseScoped: false, badge: "LDR" },
      { path: "/ldr-precedents", label: "LDR Precedents", labelEn: "LDR Precedents", icon: BookOpen, caseScoped: false, badge: "LDR" },
      { path: "/ldr-reply", label: "LDR Reply", labelEn: "LDR Reply", icon: FileText, caseScoped: false, badge: "LDR" },
  ...
  },
  {
    ...
    secondary: [
      ...
      { path: "/draft-family",       label: "ड्राफ्ट फैमिली", labelEn: "Draft Family",      icon: Files,   caseScoped: true, badge: "NEW" },
