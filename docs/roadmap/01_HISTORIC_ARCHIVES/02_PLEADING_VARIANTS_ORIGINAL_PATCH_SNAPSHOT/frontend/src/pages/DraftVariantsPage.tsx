...
export default function DraftVariantsPage() {
  ...
  useEffect(() => {
    variantsApi.subjects().then((s) => setSubjects(s))
  }, [])
  useEffect(() => {
    ...
    <div className="container mx-auto max-w-6xl space-y-6 py-8 px-4">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="space-y-3">
          ...
          <CitationAddToDraft
            onInsert={(hit) => {
              if (!addCitationToDraft(activeNode, hit)) {
                // tier guard — should be unreachable, button is disabled
                return
              }
            }}
          />
